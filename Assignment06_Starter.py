...
# Jin,11.16.2019,Modified code to complete assignment 6
# ------------------------------------------------------------------------ #
...
class FileProcessor:
    ...
    @staticmethod
    def WriteListDataToFile():
        """
        Desc- write data from the list of dictionary rows to a file
        :return: nothing
        """
...
class IO:
    ...
    @staticmethod
    def EnterNewData():
        """ask the user for input of new task and priority and add it to the current table
        :param strTask: new task from user
        :param strPriority: new priority from user
        :return """
    ...
    @staticmethod
    def RemoveSelectedData(strKeyToRemove):
        """ask user for the task to remove, remove if found otherwise return not found
        :param strKeyToRemove: task to be removed from user
        :return: nothing
        """
...
while(True):
    ...
    # Step 3.3 - Remove a new item to the list/Table
        ...
        blnItemRemoved = IO.RemoveSelectedData(strKeyToRemove)
